...
pub fn construct_comment_view_async(
    ...
    AsyncView::new_with_bg_creator(siv, move || Ok(client.lazy_load_story_comments(id)), {
        ...
        move |result: Result<_>| {
            ResultView::new(result, |receiver| {
                comment_view::get_comment_view(&story, receiver)
            })
        }
    })
...
//                     numeric_filters,
//                 )),
//                 Err(err) => ErrorViewEnum::Err(result_view::get_error_view(
//                     &format!(
...
//                     Err(err) => {
//                         ErrorViewEnum::Err(result_view::get_error_view(&err_desc, &err.to_string()))
//                     }
//                 })
//             }
//         },
